c AAUJVAVILOV. PROGRAMS FOR THE LANDAU AND THE VAVILOV DISTRIBUTIONS AND  AAUJ0000
c 1   THE CORRESPONDING RANDOM NUMBERS.  SCHORR, B                        AAUJ0000
c REF. IN COMP. PHYS. COMMUN. 7 (1974) 215                                AAUJ0000
c XJOB.SCHORR,0405VA,COM,                                                 AAUJ0001
c FUN(S).                                                                 AAUJ0002
c LGO.                                                                    AAUJ0003
c $              END OF RECORD                                            AAUJ0004

      PROGRAM TESVAV  ! (INPUT,OUTPUT,TAPE1=INPUT,TAPE2=OUTPUT)             AAUJ0005
C                                                                       AAUJ0006
C     TEST RUN FOR THE VAVILOV DISTRIBUTION                             AAUJ0007
C                                                                       AAUJ0008
      DIMENSION X(10),Y(10),Z(3,10)                                     AAUJ0009
      LIN=5                                                             AAUJ0010
      LOUT=6                                                            AAUJ0011
      M=0                                                               AAUJ0012
      RKA=0.01                                                          AAUJ0013
      ...
      S=0.99                                                            AAUJ0015
C                                                                       AAUJ0016
  106 READ(LIN,3) (X(I),I=1,10)                                         AAUJ0017
      READ(LIN,3) (Y(I),I=1,10)                                         AAUJ0018
      WRITE(LOUT,99)                                                    AAUJ0019
      WRITE(LOUT,104) RKA,BE2                                           AAUJ0020
C                                                                       AAUJ0021
      CALL COEDIS(RKA,BE2,0,-2)                                         AAUJ0022
C                                                                       AAUJ0023
      DO 1 I = 1,10                                                     AAUJ0024
    1 Z(1,I)=DISVAV(X(I),0)                                             AAUJ0025
      CALL COEDIN(RKA,BE2,-2)                                           AAUJ0026
      WRITE(LOUT,100)                                                   AAUJ0027
C                                                                       AAUJ0028
      DO 2 I = 1,10                                                     AAUJ0029
      Z(2,I)=DISVAV(X(I),1)                                             AAUJ0030
    2 Z(3,I)=DINVAV(Z(2,I)/S)                                           AAUJ0031
C                                                                       AAUJ0032
      DO 4 I = 1,10                                                     AAUJ0033
      WRITE(LOUT,101) X(I),Z(3,I),Z(1,I),Y(I),Z(2,I)                    AAUJ0034
    4 CONTINUE                                                          AAUJ0035
C                                                                       AAUJ0036
      IF(M .EQ. 1) GO TO 105                                            AAUJ0037
      M=1                                                               AAUJ0038
      RKA=4.0                                                           AAUJ0039
      BE2=0.5                                                           AAUJ0040
      S=0.995                                                           AAUJ0041
      GO TO 106                                                         AAUJ0042
C                                                                       AAUJ0043
    3 FORMAT(5F10.0)                                                    AAUJ0044
   99 FORMAT(1H1,23X,40HTEST VALUES FOR THE VAVILOV DISTRIBUTION//)     AAUJ0045
  104 FORMAT(29X,7HKAPPA =,F5.2,4X,9HBETA**2 =,F5.1//)                  AAUJ0046
  100 FORMAT(10X,8HABSCISSA,5X,7HINVERSE,2(6X,7HDENSITY,3X),14H  DISTRIBAAUJ0047
     1UTION/21X,11HCONDITIONAL,2(4X,8HFUNCTION,4X),10H  FUNCTION/20X,13HAAUJ0048
     2DISTR. FUNCT.,3X,8H(DISVAV),4X,16H(SELTZER-BERGER)/)              AAUJ0049
  101 FORMAT(F17.3,F12.3,F14.5,2F15.5)                                  AAUJ0050
  105 STOP                                                              AAUJ0051
C                                                                       AAUJ0052
      END                                                               AAUJ0053
      FUNCTION DISVAV(X,I)                                              AAUJ0054
C                                                                       AAUJ0055
...
C                                                                       AAUJ0158
      IF(J .GT. 0) WRITE(J,10) T0,T1                                    AAUJ0159
      T=T1-T0                                                           AAUJ0160
...
C                                                                       AAUJ0171
    ...
    3 Q=-Q                                                              AAUJ0192
      RETURN                                                            AAUJ0193
C                                                                       AAUJ0194
    6 WRITE(LU,7) RKA                                                   AAUJ0195
      RETURN                                                            AAUJ0196
C                                                                       AAUJ0197
    8 WRITE(LU,9) BE2                                                   AAUJ0198
...
C                                                                       AAUJ0219
      ...
      IF(J .GT. 0) WRITE(J,4) TR                                        AAUJ0224
...
C                                                                       AAUJ0610
    5 F1=F2                                                             AAUJ0611
      ...
      GO TO 1                                                           AAUJ0615
C                                                                       AAUJ0616
   16 WRITE(LU,301)                                                     AAUJ0617
      RETURN                                                            AAUJ0618
C                                                                       AAUJ0619
   17 WRITE(LU,300) X,G,LFCN                                            AAUJ0620
...
C                                                                       AAUJ0625
      END                                                               AAUJ0626
c $                                                                       AAUJ0627
c -3.0      -2.0      -1.0      0.0       5.0                             AAUJ0628
c 10.0      15.0      20.0      30.0      34.0                            AAUJ0629
c 0.00068   0.04440   0.15300   0.18100   0.03960                         AAUJ0630
c 0.01210   0.00546   0.00304   0.00131   0.00101                         AAUJ0631
c -3.5      -3.25     -3.0      -2.75     -2.5                            AAUJ0632
c -2.25     -2.0      -1.75     -1.5      -1.25                           AAUJ0633
c 0.00945   0.06880   0.26400   0.60000   0.88100                         AAUJ0634
c 0.89500   0.66300   0.37300   0.16400   0.05850                         AAUJ0635
c $                                                                       AAUJ0636
                                                                        AAUJ****
